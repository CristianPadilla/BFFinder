...
const Profile = () => {
  ...
  const handleSaveForm = () => {
    // Realizar acciones necesarias para guardar la información
    // Puedes actualizar el estado de isEditing para salir del modo de edición
    setIsEditing(false);
  };
  ...
  const userToDisplay = user
    ? {
        ...
        department: user.location.city.department.name,
        more_info: user.location.more_info,
      }
    : {
        name: "Nombre",
        ...
        <CardContent sx={{ margin: ".7rem" }}>
          <Grid container spacing={2} justifyContent="center">
            <Grid item xs={12} sm={5}>
              ...
              <Typography variant="h6" sx={{ marginBottom: 2}}>Datos de la fundación</Typography>
            ...
            <Grid item xs={12} sm={6} sx={{ textAlign: "justify" }}>
              ...
              <Typography variant="h5" sx={{ marginTop: ".6rem", marginBottom: 1 }}>
                {userToDisplay.name}
              </Typography>
              ...
              <Typography variant="h6" sx={{ marginBottom: 2}}>Ubicación</Typography>
